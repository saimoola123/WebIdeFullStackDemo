		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WebIDE Full Stack Demo",
									"targetURL": "#WebIDEFullStackDemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"WebIDEFullStackDemo-display": {
								"semanticObject": "WebIDEFullStackDemo",
								"action": "display",
								"description": "Demonstration of Web Ide Full Stack Features ",
								"title": "WebIDE Full Stack Demo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sai.moola.WEBIDEFSDEMO",
									"url": sap.ui.require.toUrl("sai/moola/WEBIDEFSDEMO")
								}
							}
						}
					}
